...
const logos = [
  ...
  { name: 'Google Ads', url: 'https://cdn.simpleicons.org/google/ffffff', size: 46, x: '60%', y: '68%', delay: 0.1 },
  { name: 'YouTube', url: 'https://cdn.simpleicons.org/youtube/ff3131', size: 48, x: '82%', y: '60%', delay: 0.3 },
  // Use white variant for reliability/contrast and add robust fallback
  { name: 'LinkedIn', url: 'https://cdn.simpleicons.org/linkedin/ffffff', size: 42, x: '38%', y: '28%', delay: 0.25 },
];
